...
const projectsData = [
  {
    ...
    images: [
      {
        url: '/contactos1.jpg',
        alt: 'Lista de contactos guardados',
      },
      {
        url: '/contactos2.jpg',
        alt: 'Formulario para crear un nuevo contacto',
      },
      {
        url: '/contactos3.jpg',
        alt: 'Perfil de usuario y selección de avatar',
      },
    ],
  },
  {
    ...
    images: [
      {
        url: '/VIsualizador-tiempo1.jpg',
        alt: 'Vista del Sistema Solar',
      },
      {
        url: '/Vizualizador-tiempo2.jpg',
        alt: 'Vista del Ciclo Lunar',
      },
      {
        url: '/Vizualizador-tiempo3.jpg',
        alt: 'Vista de la Vela consumiéndose',
      },
    ],
  },
  {
